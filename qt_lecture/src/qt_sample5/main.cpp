...
int main(int argc, char * argv[])
{
  ...
  QObject::connect(
    check, &QCheckBox::stateChanged, touch_widget,
    qOverload<int>(&TouchWidget::setEnabled));
  QObject::connect(
    touch_widget, qOverload<QString>(
      &TouchWidget::notifyScaledPoint), label, &QLabel::setText);
